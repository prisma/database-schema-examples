...
COPY public.accounts (id, username, domain, secret, private_key, public_key, remote_url, salmon_url, hub_url, created_at, updated_at, note, display_name, uri, url, avatar_file_name, avatar_content_type, avatar_file_size, avatar_updated_at, header_file_name, header_content_type, header_file_size, header_updated_at, avatar_remote_url, subscription_expires_at, locked, header_remote_url, last_webfingered_at, inbox_url, outbox_url, shared_inbox_url, followers_url, protocol, memorial, moved_to_account_id, featured_collection_url, fields, actor_type, discoverable, also_known_as, silenced_at, suspended_at, trust_level) FROM stdin;
...
--
-- Data for Name: account_identity_proofs; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: account_tag_stats; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
COPY public.announcements (id, text, published, all_day, scheduled_at, starts_at, ends_at, created_at, updated_at, published_at) FROM stdin;
\.
...
COPY public.mutes (id, created_at, updated_at, hide_notifications, account_id, target_account_id) FROM stdin;
\.
...
--
-- Name: account_identity_proofs_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
--
-- Name: account_tag_stats_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
